...
# Use max depth of 3 means we get level as far as 3 splits that's all in this example.
# you can go higher but if you go to high could overfit and that will be a BIG issue
