...
## CREATE DUMMY DATA (here we open csv.file usually)
...
## PLOT ROC CURVE (fpr =false postivite rate , tpr =true posotive rate )
# normally FPR , TPR,  TRESHOLD , in this example we specify 0:2 becuase we do NOT use THRESHOLD in here
